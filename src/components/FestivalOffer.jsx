    ...
    const OfferItems = [
        {
            ...
            btn: (<CommonBtn cstm="!py-[10px] !px-3 my-[43px]" text="ADD TO CART" />)
        },
        {
            ...
            <div className="grid grid-cols-2 gap-9">
                {
                    OfferItems.map((items, index) => (
                        <div key={index} className={items.bgImg}>
                            <div className='py-8 px-[107px]'>
                                <p className='headingLine2 before:-left-[107px] text-black text-xl font-Poppins font-normal leading-normal'>{items.title}</p>
